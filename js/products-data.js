// Начальный каталог товаров для Namelees Visual
const DEFAULT_PRODUCTS = [
  {
    ...
    fullDesc: "Nebula 16x — авторский ресурспак от Namelees Visual, созданный специально для анархии и PvP-серверов. Все текстуры переработаны для максимальной видимости в бою, не загромождают экран и дают прирост до +25% FPS за счет оптимизации моделей.",
    features: [
  ...
  },
  {
    ...
    shortDesc: "Базовый бесплатный пак от Namelees Visual для знакомства с нашими текстурами.",
